...
namespace TaskMgr {
            ...
            bool OnWindowEnum(IntPtr hWnd, int lparam) {
                ...
                if (GetParent(hWnd) == IntPtr.Zero) {
                    ...
                    if (isVisible == true) {
                        ...
                        windowList.Add(new WindowInfo(hWnd, className, title, isVisible, bounds, pID));
                    }
                }
                return true;
            }
    ...
    public readonly struct WindowInfo {
        public WindowInfo(IntPtr hWnd, string className, string title, bool isVisible, Rectangle bounds, int pID) : this() {
            Hwnd = hWnd;
            ClassName = className;
            Title = title;
            IsVisible = isVisible;
